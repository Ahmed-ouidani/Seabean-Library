<?php
    ...
    if(isset($_GET['delete'])){
        ...
        header('location:admin_reservations.php?success=ReservationSupprimer');
    }
...
<html lang="fr">
    <head>
        ...
        <title>Reservations | Seabens Library</title>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav ms-auto my-2 my-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link p-lg-3 p-2 active" href="#">Reservations</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container d-flex justify-content-center mt-4">
            <?php
                if(isset($_GET['error'])){
                    if(($_GET['error'] == "ReservationSupprimer")){ ?>
        ...
        <div class="content container mt-5 mb-5 comptes">
            <h1 class="t-font t-black d-flex justify-content-center">Reservations</h1>
            <div class="row mt-4">
                <?php
                    $premier = ($currentPage * $parPage) - $parPage;

                    $sql = "SELECT id, date_prendre, date_remis, name, email, book_id FROM reservation LIMIT :premier, :parpage";
                    ...
                    <div class="col-lg-3-perso col-md-6-perso col-11 elements-ad p-4 mt-4 ms-1 me-1">
                        <div class="t-font t-black d-flex justify-content-center p-4 pb-0">
                            <div class="box">
                                ...
                                <p> Date de prendre : <span><?php echo $result['date_prendre']; ?></span> </p>
                                <p> Date de remis : <span><?php echo $result['date_remis']; ?></span> </p>
                                <a class="rounded-pill main-btn p-2" href="admin_reservations.php?delete=<?php echo $result['id']; ?>" onclick="return confisrm('delete this user?');" class="delete-btn">Suprimmer la reservation</a>
                            </div>
                        </div>
                    </div>
                <?php
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    <?php for($page = 1;$page <= $pages ; $page++){ ?>
                                        <li class="page-item <?= ($currentPage == $pages) ? "active-aaaa" : "" ?>"><a class="page-link" href="admin_reservations.php?page=<?php echo $page;?>"><?php echo $page;?></a></li>
                                    <?php } ?>
